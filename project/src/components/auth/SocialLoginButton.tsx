import { Donut as Button, Facebook, Loader2 } from 'lucide-react';
...
export default function SocialLoginButton({ 
  ...
  // In a real app, you would use the actual SDK methods from Google/Facebook
  const handleLogin = () => {
    setIsLoading(true);
    ...
    setTimeout(() => {
      ...
      if (provider === 'google') {
        const mockGoogleResponse = {
          ...
          // The JWT would be decoded by the auth store to extract user details
        };
  ...
  return (
    <button
      ...
      className={cn(
        ...
        provider === 'google' ? 'btn-secondary' : 'bg-[#1877F2] text-white hover:bg-[#0E67E3]',
